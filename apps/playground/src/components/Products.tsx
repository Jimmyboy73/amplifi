export default function Products() {
  return (
    <section id="products" className="py-24 bg-offwhite">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl font-bold text-midnight mb-5 tracking-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="bg-white rounded-2xl p-8 md:p-10 border border-slate-200 shadow-sm">
            <div className="w-12 h-12 bg-amber/10 rounded-xl flex items-center justify-center mb-6 text-2xl">
              ✨
            </div>
            <div className="inline-block bg-amber/10 text-amber-700 text-sm font-medium px-3 py-1 rounded-full mb-5">
              For parents &amp; grandparents
            </div>
            <h3 className="text-3xl font-bold text-midnight mb-4">Spark</h3>
          ...
          {/* Launchpad card */}
          <div className="bg-midnight rounded-2xl p-8 md:p-10 shadow-sm">
