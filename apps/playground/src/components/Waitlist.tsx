...
export default function Waitlist() {
  ...
  return (
    <section id="waitlist" className="py-24 bg-midnight">
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-sky/60 transition"
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <select
                  ...
                  name="interest"
                  required
                  className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-sky/60 transition appearance-none"
                >
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-amber text-midnight font-semibold py-4 rounded-xl hover:bg-amber/90 active:scale-[0.99] transition-all disabled:opacity-50 disabled:cursor-not-allowed text-lg"
              >
