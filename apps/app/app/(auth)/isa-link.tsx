...
export default function IsaLinkScreen() {
  ...
  const handleSortCodeChange = (v: string) => setSortCode(formatSortCode(v))
  const handleAccountChange = (v: string) => setAccountNumber(v.replace(/\D/g, '').slice(0, 8))
    ...
    <SafeAreaView style={styles.safe}>
      ...
      >
        ...
        >
          ...
          {insertError ? <Text style={styles.errorText}>{insertError}</Text> : null}
...
const styles = StyleSheet.create({
  ...
  helpHint: { fontSize: 12, color: '#94a3b8', marginTop: 5, lineHeight: 17 },
  accordionHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 14, borderTopWidth: 1, borderTopColor: '#f1f5f9' },
  accordionLabel: { fontSize: 14, fontWeight: '600', color: colors.sky },
  accordionChevron: { fontSize: 11, color: colors.sky },
  accordionBody: { backgroundColor: '#f8fafc', borderRadius: 12, padding: 16, marginBottom: 20, gap: 12 },
  providerRow: { gap: 2 },
  providerName: { fontSize: 13, fontWeight: '700', color: colors.midnight },
  providerLocation: { fontSize: 12, color: '#64748b', lineHeight: 17 },
  confirmCard: { backgroundColor: '#f0fbff', borderWidth: 1, borderColor: `${colors.sky}55`, borderRadius: 14, padding: 16, marginBottom: 12, marginTop: 4 },
  confirmText: { fontSize: 14, color: '#475569', lineHeight: 22 },
  confirmBold: { fontWeight: '700', color: colors.midnight },
  errorText: { fontSize: 13, color: '#ef4444', marginBottom: 12, lineHeight: 19 },
  cta: { backgroundColor: colors.sky, borderRadius: 16, paddingVertical: 16, alignItems: 'center', marginTop: 4 },
