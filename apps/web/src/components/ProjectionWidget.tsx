...
export function ProjectionWidget({
  ...
  return (
    <div className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-black/5">
      ...
      {points == null ? (
        <p className="mt-4 rounded-xl bg-offwhite p-4 text-sm text-slate-500">
          Add {childName}'s date of birth to see projected figures.
        </p>
      ) : (
        <>
          ...
          <p className="mt-3 text-center text-[11px] italic text-slate-400">
            Illustrative projection at 7% p.a. — not a guarantee.
          </p>
        </>
      )}
    </div>
