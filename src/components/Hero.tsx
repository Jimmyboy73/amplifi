export default function Hero() {
  return (
    <section className="relative bg-brand-navy min-h-screen flex items-center overflow-hidden">
      {/* Background decorative blobs */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-[600px] h-[600px] bg-brand-teal/10 rounded-full blur-3xl" />
        <div className="absolute -bottom-20 -left-20 w-[500px] h-[500px] bg-brand-amber/10 rounded-full blur-3xl" />
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24 pt-36 md:pt-40">
        <div className="max-w-3xl">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 text-white/80 text-sm px-4 py-2 rounded-full mb-8 border border-white/20">
            <span className="w-2 h-2 bg-brand-amber rounded-full animate-pulse flex-shrink-0" />
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white leading-[1.05] tracking-tight mb-6">
            Build your child's{' '}
            <span className="text-brand-amber">financial future</span>{' '}
            together.
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              href="#waitlist"
              className="inline-flex items-center justify-center bg-brand-amber text-brand-navy font-semibold px-8 py-4 rounded-xl hover:bg-amber-400 transition-colors text-lg"
            >
              Join the waitlist
            </a>
            <a
